...
export default function Icon({ href, src, alt, text }) {
  return (
    <Link
      to={href}
      className="lg:w-full lg:justify-center flex gap-2 items-center p-2 md:p-4 border border-1 border-orange-700 rounded-md cursor-pointer hover:bg-orange-100 hover:duration-500"
    >
