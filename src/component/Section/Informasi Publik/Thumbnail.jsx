export const Thumbnail = ({ bg, note, title, description }) => {
  return (
    <div
      className="w-full flex flex-col lg:h-[500px] xl:h-[600px] justify-between lg:p-[60px] rounded-[12px]"
      style={{
    ...
    >
      <h1 className="w-fit px-5 py-3 bg-teal-700 rounded-md justify-center items-center text-white lg:text-lg font-medium font-[Poppins]">
        {note}
      </h1>
